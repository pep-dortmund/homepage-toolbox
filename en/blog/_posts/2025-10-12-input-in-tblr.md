...
`tblr` Umgebung aus dem [`tabularray`](https://mirrors.ctan.org/macros/latex/contrib/tabularray/tabularray.pdf)
...
in der [Dokumentation zu `tabularray` in Abschnitt 5.5.2](https://mirrors.ctan.org/macros/latex/contrib/tabularray/tabularray.pdf).
