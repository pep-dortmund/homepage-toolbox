...
1. Open VSC and go to *File* > *Open Folder*. 
   ...
   e.g., first `Ctrl`+`k` then `Ctrl`+`o`. 
   In the window that appears, navigate to the folder
   you want to work in and open it.
   ```{image} /img/introduction/VSCode_NewDir1.png
   :alt:
   :align: center
   ```
2. If you are in a terminal, you can navigate to the desired folder using `cd`. 
  Once there, you can open the folder in VSC using `codium .` (if you have VSCodium installed)
  or `code .` (for VSCode on Windows).
