...
kannst du der Anleitung ab {ref}`bootstick` folgen.
...
**<div style="color:crimson">Deshalb solltest du als Erstes ein vollständiges
Backup deines Rechners machen, bevor du weitermachst!</div>**
...
**Für Einsteiger empfehlen wir [Linux Mint](https://www.linuxmint.com/) oder [Fedora](https://fedoraproject.org/).**
[Endeavour](https://endeavouros.com/) ist eine Arch-basierte Distrubition, die wir empfehlen,
...
1. Installiere das Tool {gui}`Rufus`, um das Image auf einen USB-Stick zu schreiben:
   [rufus.akeo.ie](https://rufus.ie/en/).
